      ...
      <View style={[ComponentStyles.container_v2, { alignItems: "center" }]}>
        ...
        <View style={styles.scanContainer}>
          ...
          <Image
            ...
            source={require("src/assets/images/icon_QRcode.png")}
          ></Image>
          <TouchableOpacity
            style={styles.scanBtnContainer}
            onPress={() =>
              props.navigation.navigate("ScanQR", { countHelp: 0 })
            }
          >
            <Image
              style={styles.scanCam}
              source={require("src/assets/images/icon_scanQR_camera.png")}
            ></Image>
      ...
      {helpCount === undefined && hasNext === 1 ? (
        ...
        helpCount === 3 && (
          <TutorBox
            mouseNum={1}
            text={
              "You can also use the photo scan to take a photo of the food directly"
            }
            mouse1left={300}
            mouse1top={hp("66%")}
            circle={0}
